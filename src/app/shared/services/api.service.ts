...
export class ApiService {
    ...
    login(payload: LoginRequestInterface): Observable<string> {
        ...
        } else if (payload.email === 'test@unverified.expert') {
            return of('eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..1BLphStqYomt5xKpRfyek87dt7ziFHTJ-m4PnQKcrmU');
        } else if (payload.email === 'test@admin') {
            return of('eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..G-YGrbs2AR0OfleHQHWf2oQE31XNjNVuxqU6dkY9bMY');
        } else if (payload.email === 'test@user') {
            return of('eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..HD96Q7IGhGzGXZgkyw0NqXeDXOZN8vgxLK4C54VJ0-s');
        }
